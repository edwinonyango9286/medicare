...
import { IsAuthenticated } from '../query/user'
                ...
                <div className="basis-1/3">
                    ...
                    {!IsAuthenticated ?
                        ...
                        <Link style={{height:"100%"}} to="/profile">
                            <button style={{height:"100%"}} className="px-5 hover:bg-green-800 hover:text-indigo-100">Profile</button>
                        </Link>
                    }
                </div>
            ...
            <div className="absolute bg-gradient-to-b from-green-400 to-green-200 opacity-75 inset-0 z-0"></div>
                <div className="min-h-screen overflow-scroll p-3">
                    <div className="flex mx-0">
                        <div className="z-10 ">
                            <div className="min-h-screen sm:flex sm:flex-row mx-0 justify-center" style={{"width":"100vw"}}>
                                {children}
                            </div>
                        </div>
                    </div>
